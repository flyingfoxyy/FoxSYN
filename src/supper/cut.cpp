...
// template <typename T>
// bool cut_t<T>::merge_cut(cut_t<T> *lhs, cut_t<T> *rhs, int lut_size)
// {
...
// template <typename T>
// Area cut_t<T>::ref_mffc(const LutLib &lib)
// {
...
//             continue;
//         area += node->get_best_cut()->ref_mffc(lib);
//     }
//     return area;
// }
// {
//     Area area = cut_t::get_area_cost(this);
//     for (int i = 0; i != size; ++i)
//     {
